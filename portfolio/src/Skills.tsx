        ...
        <Section id="skills" title="Skills"  >
            <div className="flex flex-col gap-4 items-left justify-center p-10">
                <FadeInWhenVisible>
                    ...
                    <h2 className="text-3xl text-primary font-bold dark:text-dark-primary">
                        Education
                    </h2>
                </FadeInWhenVisible>
                <FadeInWhenVisible>
                    <p className="inline-flex text-1xl text-black bg-primary p-3 rounded-2xl dark:bg-dark-primary">
                        National University of Singapore (NUS) <br />
                        Bachelor of Computing (BComp) in Computer Science <br />
                        Focus Areas in Artificial Intelligence and Database Systems
                    </p>
                </FadeInWhenVisible>
                <FadeInWhenVisible>
                    <h3 className="text-1xl text-secondary dark:text-dark-secondary">
                ...
                <FadeInWhenVisible>
                    ...
                    <div className="flex flex-wrap gap-4 items-center justify-center bg-primary p-2 rounded-2xl dark:bg-dark-primary">
                        ...
                        <SkillCard title="HTML" description='Structure of Web Content' image={<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-original-wordmark.svg" />}></SkillCard>
                        <SkillCard title="CSS" description='Styles and Layout for Web' image={<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original-wordmark.svg" />}></SkillCard>
                    </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible>
                    <p className="text-2xl text-black dark:text-white">
                ...
                <FadeInWhenVisible>
                    <p className="text-2xl text-black dark:text-white">
                        ...
                        <div className="inline-flex flex-wrap gap-4 items-center justify-center bg-primary p-3 rounded-2xl dark:bg-dark-primary">
                            <SkillCard title="Git" description="Version Control System" image={<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/git/git-original-wordmark.svg" />}></SkillCard>
                            <SkillCard title="Atlassian" description="Team Collaboration and Devops Tools" image={<img src="https://cdn.brandfetch.io/idlQIwGMOK/theme/dark/logo.svg?c=1dxbfHSJFAPEGdCLU4o5B" />}></SkillCard>
                            <SkillCard title="Docker" description="Containerised Deployment Platform" image={<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-plain-wordmark.svg" />}></SkillCard>
                            <SkillCard title="Kubernetes" description="Container Orchestration and Scaling System" image={<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/kubernetes/kubernetes-original-wordmark.svg" />}></SkillCard>
                        </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible>
                    <p className="text-2xl text-black dark:text-white">
                ...
                <FadeInWhenVisible>
                    <p className="text-2xl text-black dark:text-white">
                        ...
                        <div className="inline-flex flex-wrap gap-4 items-center justify-center bg-primary p-3 rounded-2xl dark:bg-dark-primary">
                            <SkillCard title="Unity" description="Game Engine" image={<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/unity/unity-original-wordmark.svg" />}></SkillCard>
                        </div>
                </FadeInWhenVisible>
