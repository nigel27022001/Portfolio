        ...
        <Section id="contact">
            <FadeInWhenVisible>
                ...
                <div className="flex flex-wrap gap-4 justify-center items-center">
                    <div className="flex flex-col gap-4 items-center justify-center">
                        <a href="mailto:nigellim27022001@gmail.com">
                            <div className="bg-tertiary  overflow-hidden rounded-xl shadow-lg p-10 gap-4 w-48 h-48 flex flex-col items-center hover:shadow-2xl hover:scale-105 transition dark:bg-dark-secondary">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-center">
                        <a href="https://github.com/nigel27022001">
                            <div className="bg-tertiary  overflow-hidden rounded-xl shadow-lg p-10 gap-4 w-48 h-48 flex flex-col items-center hover:shadow-2xl hover:scale-105 transition dark:bg-dark-secondary">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-center">
                        <a href="https://www.linkedin.com/in/nigel-lim-xi-tong/">
                            <div className="bg-tertiary  overflow-hidden rounded-xl shadow-lg p-10 gap-4 h-48 w-48 flex flex-col items-center hover:shadow-2xl hover:scale-105 transition dark:bg-dark-secondary">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-center">
                        <a href="https://www.instagram.com/not_nigel_lim/">
                            <div className="bg-tertiary  overflow-hidden rounded-xl shadow-lg p-10 gap-4 h-48 w-48 flex flex-col items-center hover:shadow-2xl hover:scale-105 transition dark:bg-dark-secondary">
                                <h3 className="text-black">Instagram</h3>
                                <svg 
                                    xmlns="http://www.w3.org/2000/svg" 
                                    viewBox="0 0 448 512"
                                    width={48}
